...
export default function AskingOut() {
    return (
        <div className="w-full h-full md:max-w-[400px] shadow-[0px_4px_20px_0px_rgba(0,0,0,0.05)] bg-white rounded-[48px] flex flex-col items-center justify-start pt-20 p-8 gap-y-4">
             <Image 
                src={Cat}
                alt="Cat"
                width={200}
